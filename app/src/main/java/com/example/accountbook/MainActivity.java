...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* 入金か出金か */
//        RadioGroup rg = findViewById(R.id.io);  // ラジオグループのオブジェクトを取得
//        int rb_info = rg.getCheckedRadioButtonId();
//        RadioButton rb = findViewById(rb_info); //チェックされて色ラジオボタンオブジェクトを取得
        ...
        register.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, com.example.accountbook.Add.class));
            }
        });
...
//                String purchase = purchaseText.getText().toString();
//                String price = priceText.getText().toString();
//                if(date.equals("") || purchase.equals("") ||  price.equals("")){
//                    Toast.makeText(MainActivity.this, "入力されていない項目があります", Toast.LENGTH_LONG).show();
//                }
//                else {
//                    if(helper == null) { helper = new TestOpenHelper(getApplicationContext()); }
//                    SQLiteDatabase db = helper.getWritableDatabase();
//                    String sql = "delete from testdb where (date=\'"+date+"\' and purchase=\'"+purchase+"\' and price=\'"+price+"\');";
//                    db.execSQL(sql);
...
//
    ...
    private void readData() {
        ...
        Cursor cursor = db.query(
                "testdb",
                new String[] { "ie", "date", "purchase", "price" },
                null,
                null,
                null,
                null,
